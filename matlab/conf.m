...
test_type = 2;  % 实验测试类型：1--多次重复CV的多数据集标准测试   2--二维数据可视化实验
...
%      'DDTools_Incsvdd(#0.1#)'
%       'Meta_ClustEOCC(#''entropy''#,#10#,#''kcentres''#,#''mst_dd(A,0.05)''#,#mergec#)',...
%      'Meta_ClustEOCC(#''direct''#,#2#,#''kmeans''#,#''mst_dd(A,0.05)''#,#mergec#)',...
     'E12_DBCV_MST(#''kmeans''#,#2#,#0.05#)'
%     'DDTools_Incsvdd(#0.1#)'
